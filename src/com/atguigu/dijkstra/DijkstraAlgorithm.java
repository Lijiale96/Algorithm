...
//已访问顶点集合
class VisitedVertex{
    //记录各个顶点是否访问过 1表示访问过，动态更新
    public int[] already_arr;
    //每个下标对应的值为前一个顶点的下标，动态更新
    public int[] pre_visited;
    //记录出发顶点到其他所有顶点的距离，比如G为出发顶点，就会记录G到其他顶点的距离，动态更新，求最短距离就会存放到dis
    public int[] dis;
     ...
     * 功能：判断index顶点是否被访问过
     * @param index
     * @return 如果访问过，就访问true，否则就访问false
     */
    ...
    public void show(){
        ...
        for (int i :dis){
            if (i!=65535){
                System.out.println("该站到"+vertex[count]+"站最短距离为"+i+"。");
            }else{
